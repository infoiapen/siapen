...
if (preg_match('/^\([0-9]{2}\)?\s?[0-9]{4,5}-[0-9]{4}$/', $valor)):
 ...
 ?>
	<div class='container'>
		<fieldset>
			<legend><h1>Formulário - Cadastro de Internos</h1></legend>
			...
			<form action="action_cliente.php" method="post" id='form-contato' enctype='multipart/form-data'>
			    ...
			    <div class="form-group">
			      ...
			      <input type="data_nascimento" class="form-control" id="data_nascimento" maxlength="10" name="data_nascimento" placeholder="Exemplo: 00/00/0000 ou 00/00/00">
